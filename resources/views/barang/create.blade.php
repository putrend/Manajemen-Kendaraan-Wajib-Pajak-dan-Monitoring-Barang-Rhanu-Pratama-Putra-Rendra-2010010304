...
<form action="/barang" method="post">
    ...
    <input type="number" name="jumlah_barang" id="jumlah" onchange="total()" placeholder="Masukkan Stok"
        class="form-control">
    <label for="harga_total">Total</label>
    <input type="number" name="harga_total" id="totHarga" placeholder="Total Harga..." class="form-control" readonly>

<nav class="main-header navbar navbar-expand-lg bg-light">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <span class="fw-bold">Selamat Datang di Aplikasi Monitoring Barang Samsat Banjarbaru, Anda Login Sebagai <span class="text-danger">{{ ucfirst(auth()->user()->role) }}</span></span>
        </div>
    </div>
    @auth
        <ul class="navbar-nav">
